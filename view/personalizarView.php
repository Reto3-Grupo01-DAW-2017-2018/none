<!--
    ...
    <meta name="description" content="Hoja de personalización de la página">
...
<div class="container">
    <div class="out-wrap">
        ...
        <div class="tab-container">
            ...
            <div id="divColor" class="tab-panes">
            ...
            <div id="contenedorColorSelected" style="background-color:white;">
                <div><br>
                    <p>Color seleccionado</p>
                    <div id="colorSelected"><p></p></div>
                </div><br><br>
                <p>color letra:</p>
                <p>blanco/negro</p>
                <div class="toggle">
                ...
                <button id="botonAceptarColor">Aceptar</button>
            </div>
        </div>
    </div>
</div>
